<footer class="h-36 w-full lg:w-[80%] mx-auto mt-0 py-1">
    <div class="px-8 {{-- pt-16 --}} mx-auto max-w-7xl lg:px-12 xl:px-5">
        ...
        <div class="flex flex-wrap justify-between items-start pb-20">    
            ...
            >
                <img src="{{ asset("img/gs-logo.png") }}" style="max-width: 40px;" alt="Planner Logo" />
                Glacial Studio
            </a>
            ...
            <div class="grid grid-cols-2 gap-y-16 pt-2 mt-20 w-full sm:grid-cols-4 lg:gap-x-8 md:w-5/6 md:mt-0 md:pr-6">
                ...
                <div class="md:justify-self-end">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                            <a href="up" class="inline-block relative text-black group">
                                <span class="absolute bottom-0 w-full border-b border-black opacity-0 transition duration-150 ease-out transform -translate-y-1 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Status</span>
                            </a>
                        </li>
                ...
                <div class="md:justify-self-end">
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                            <a href="#contact" class="inline-block relative text-black group">
                                <span class="absolute bottom-0 w-full border-b border-black opacity-0 transition duration-150 ease-out transform -translate-y-1 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Web contact form</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="flex flex-col justify-between items-center py-10 {{-- border-t border-solid --}} lg:flex-row {{-- border-gray --}}">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0">© {{ date('Y') }} Glacial Studio. All rights reserved.</li>
                {{-- <li class="lg:ml-6">
                    <a href="#_" class="inline-block relative text-black group">
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                <li>
                    <a href="https://www.facebook.com/GlacialStudioWebSolutions" target="_blank" rel="noreferrer" class="text-zinc-600 hover:text-zinc-900">
